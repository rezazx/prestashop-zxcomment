<div class="container panel zxCommentAdmin bcomments" style="width: 100%;">
    <div class="panel-heading">
        <i class="icon-comment"></i> دیدگاه های فروشگاه :
        ...
        <table class="table meta commentList">
            ...
            {if isset($comments_list) && $comments_list}
                {foreach array_reverse($comments_list) as $c}
                    <tr id="c_{$c['id_bcomment']}" {if $c['validate']==0}class="new"{/if}>
                        <td class="c_id">{$c['id_bcomment']}</td>
                        <td class="customer">{$c['c_name']}</td>
                        <td class="c_email" >{$c['c_email']}</td>
                        <td class="c_phone" >{$c['c_phone']}</td>
                        <td class="comment">
                        ...
                        <td class="actions" actionid="{$c['id_bcomment']}">
